...
export const SignInMagicLink = ({ email = '{{email}}', url = '{{url}}' }: SignInMagicLinkProps) => {
  return (
    <Html>
      <Head />
      ...
      <Tailwind>
        <Body className="bg-[#f4f4f7] font-sans">
          <Container className="bg-white max-w-xl mx-auto p-6 rounded-lg">
            ...
            <Text className="text-base mb-2">You requested to sign in using a magic link.</Text>
            <Text className="text-base mb-4">Click the button below to access your account:</Text>
            <Button
              href={url}
            ...
            <Text className="text-base mt-4">If you did not request this email, you can safely ignore this email.</Text>
